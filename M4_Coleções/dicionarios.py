...
# Obs: Caso tetamos fazer um acesso utilizando uma chave que não existe, teremos o erro KeyError
...
# Obs: Podemos verificar se determinada chave se encontra em um dicionário
print('br' in paises)
print('ru' in paises)
...
# Tuplas por exemplo são bastante interessante de serem utilizadas como chave de dicionários, pois as mesmas
# são imutáveis.
...
nv_dado = {'mai': 500}
receita.update(nv_dado) # receita.update({'mai: 500})
print(receita)
...
# Obs: Se a chave não existir será retonado um KeyError
...
# Teriamos que saber qual é o índice de cada infromação no produto.
