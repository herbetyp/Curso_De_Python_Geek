...
abs() -> Retorna o valor absoluto de uma número inteiro ou real. De forma básica,
seria seu valor real sem o sinal
...
decimal. Se a precisao não for informada retorna o inteiro mais proximo da entrada
"""
