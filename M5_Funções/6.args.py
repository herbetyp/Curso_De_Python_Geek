...
chamar de qualquer coisa, desde que começe com asteriscos
...
O parametro *args utilizando em uma função, coloca os valores extras informados
...
# argumento uma coleção de dado. Destya forma ele sabera, que precisara antes
