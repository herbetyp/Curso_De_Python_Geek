...
de uma função. Podemos passar a execução de função para outras funções
...
# Erros comuns na utilização do retorno, que na verdade nem é um erro, mais sim codificação desnecessária

# Não a necessidade do else
